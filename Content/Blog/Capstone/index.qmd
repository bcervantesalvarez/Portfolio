...
games = pd.read_csv("../../../Assets/Datasets/Final_dev_pub.csv")
...
class_names = list(final_rf_model.classes_)  # Convert the array to a list

# Rest of your code remains the same
# plt.rcParams['font.family'] = 'SF Compact Rounded'
plt.figure(figsize=(20, 10))
plot_tree(best_decision_tree, feature_names=feature_names, class_names=class_names,
          filled=True, rounded=True, fontsize=9, max_depth=3)
plt.title("Random Forest's First Decision Tree (First 3 Levels)", fontsize=16)
plt.tight_layout()
plt.show()
plt.close()
