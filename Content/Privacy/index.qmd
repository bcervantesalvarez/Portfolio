...
<section class="container my-5 policy-section policy-form-section">
  ...
  <!-- Form without an action attribute; submission is handled via JavaScript -->
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener("submit", function(event) {
      ...
      // Disable the submit button and show loading message/animation
      submitButton.disabled = true;
      submitButton.innerHTML = "Sending...";
      loadingMessage.style.display = "block";

      const formData = new FormData(form);
      const scriptUrl = "https://script.google.com/macros/s/AKfycbz121r5O9G8YUIvGmYbSFGnC0U8nuoKfouPgqCsZHd7DFGaXv_Po81Au3JJjcc63oliCg/exec";
      ...
      .catch(error => {
        ...
        // Optionally re-enable the button and hide the loading message if there's an error
