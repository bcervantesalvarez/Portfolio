...
<section class="policy-block policy-section policy-form-section">
  ...
  <iframe id="policyFormTarget" name="policyFormTarget" style="display:none;"></iframe>

  <form id="policyForm" target="policyFormTarget"
    ...
    <input type="text" name="hp_field" tabindex="-1" autocomplete="off" style="position:absolute;left:-9999px;opacity:0;">
