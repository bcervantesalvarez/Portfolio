...
categories: [R, RShiny, Data Visualization]
---
...
<div class="download-buttons" style="text-align: center;">
  ...
  <script>
    ...
    var documentButton = createDynamicButton(
      "https://github.com/bcervantesalvarez/Portfolio/blob/main/posts/CollegeStudent_Debt_Tool/index.qmd",
      "Download .qmd"
    );
    downloadButtonsDiv.appendChild(documentButton);

    var csvButton = createDynamicButton(
      "https://github.com/bcervantesalvarez/Portfolio/blob/main/posts/CollegeStudent_Debt_Tool/collegetData.zip",
      "Download .zip"
    );
...
<iframe src="https://bcervantesalvarez.shinyapps.io/CollegeStudentSalaryDebtTools/" title="https://bcervantesalvarez.shinyapps.io/CollegeStudentSalaryDebtTools/" width="100%" height="800">
