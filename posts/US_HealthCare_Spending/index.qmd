...
description: "Cracking the Code: Unmasking the Skyrocketing US Healthcare Costs, Unveiling the Factors and Sector Impact since 1980!"
format:
  html:
    page-layout: full
    toc: true
...
execute:
  ...
  echo: false
code-fold: true
categories: [R, Linear Regression, Statistics]
---
...
<div class="download-buttons" style="text-align: center;">
  ...
  <script>
    ...
    var documentButton = createDynamicButton(
      "https://github.com/bcervantesalvarez/Portfolio/blob/main/posts/US_HealthCare_Spending/index.qmd",
      "Download .qmd"
    );
    downloadButtonsDiv.appendChild(documentButton);

    var csvButton = createDynamicButton(
      "https://github.com/bcervantesalvarez/Portfolio/blob/main/posts/US_HealthCare_Spending/healthcareSpending.csv",
      "Download .csv"
    );
