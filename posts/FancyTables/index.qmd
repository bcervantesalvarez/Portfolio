...
execute: 
  warning: false
  message: false
categories: [R, informative, interactive, datatables]
---
...
This project aims to develop a comprehensive set of guidelines for designing data tables that are easy to read and understand. By implementing these guidelines, we hope to improve the accessibility and utility of data tables for a wide range of applications and industries.
