...
<div class="download-buttons" style="text-align: center;">
  ...
  <script>
    ...
    var documentButton = createDynamicButton(
      "https://github.com/bcervantesalvarez/Portfolio/blob/main/posts/US_HealthIns_Costs/index.qmd",
      "Download .qmd"
    );
    downloadButtonsDiv.appendChild(documentButton);

    var csvButton = createDynamicButton(
      "https://github.com/bcervantesalvarez/Portfolio/blob/main/posts/US_HealthIns_Costs/insurance.csv",
      "Download .csv"
    );
